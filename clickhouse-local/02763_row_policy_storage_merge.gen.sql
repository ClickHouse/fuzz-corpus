...
SELECT * FROM 02763_merge_merge_1 ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_merge_1)';
SELECT * FROM merge(currentDatabase(), '02763_merge_merge_1') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_merge)';
SELECT * FROM merge(currentDatabase(), '02763_merge_merge') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_merge) WHERE x>2';
SELECT * FROM merge(currentDatabase(), '02763_merge_merge') WHERE x>2 ORDER BY x SETTINGS optimize_move_to_prewhere= 0;


SELECT 'SELECT * FROM engine_merge_12 WHERE x>2';
SELECT * FROM 02763_engine_merge_12 WHERE x>2 ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
...
USING (x)
ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
...
SELECT * FROM merge(currentDatabase(), '02763_merge_merge') WHERE x>1 ORDER BY x SETTINGS optimize_move_to_prewhere= 0;

SELECT *, (x=4 OR y>12) FROM merge(currentDatabase(), '02763_merge_merge') WHERE x>1 ORDER BY x SETTINGS optimize_move_to_prewhere= 0;

SELECT 'SELECT y from merge(currentDatabase(), 02763_merge)';
SELECT y from merge(currentDatabase(), '02763_merge') ORDER BY y SETTINGS optimize_move_to_prewhere= 0;
...
SELECT 'SELECT *';
SELECT * from merge(currentDatabase(), '02763_merge_fancycols') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
SELECT 'SELECT x, lc';
SELECT x, lc from merge(currentDatabase(), '02763_merge_fancycols') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
...
SELECT x, lc, cnst from merge(currentDatabase(), '02763_merge_fancycols') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
SELECT 'SELECT x, y from merge(currentDatabase(), 02763_merge';
SELECT x, y from merge(currentDatabase(), '02763_merge') ORDER BY x SETTINGS optimize_move_to_prewhere= 0;
...
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_log)';
SELECT * FROM merge(currentDatabase(), '02763_merge_log') ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_log) WHERE x>2';
SELECT * FROM merge(currentDatabase(), '02763_merge_log') WHERE x>2 ORDER BY x SETTINGS optimize_move_to_prewhere= 1;

CREATE ROW POLICY 02763_filter_2 ON 02763_merge_merge_1 USING x=4 AS permissive TO ALL;

SELECT 'SELECT * FROM 02763_merge_merge_1';
SELECT * FROM 02763_merge_merge_1 ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_merge_1)';
SELECT * FROM merge(currentDatabase(), '02763_merge_merge_1') ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge_merge)';
...
SELECT 'SELECT * FROM engine_merge_12 WHERE x>2';
SELECT * FROM 02763_engine_merge_12 WHERE x>2 ORDER BY x SETTINGS optimize_move_to_prewhere= 1;


SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge)';
SELECT * FROM merge(currentDatabase(), '02763_merge') ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
SELECT 'SELECT * FROM merge(currentDatabase(), 02763_merge) WHERE x>2';
SELECT * FROM merge(currentDatabase(), '02763_merge') WHERE x>2 ORDER BY x SETTINGS optimize_move_to_prewhere= 1;

SELECT 'aaa', x*2 as x_2, y*3 as y_3 FROM merge(currentDatabase(), '02763_merge') WHERE x>2 ORDER BY x_2 SETTINGS optimize_move_to_prewhere= 1;
SELECT x FROM (SELECT * FROM merge(currentDatabase(), '02763_merge') WHERE x IN (3,4)) ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
...
merge(currentDatabase(), '02763_merge.*2') as b
USING (x)
ORDER BY x SETTINGS optimize_move_to_prewhere= 1;
