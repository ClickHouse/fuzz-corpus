...
CREATE TABLE t_json_add_column (id UInt64) ENGINE = MergeTree ORDER BY tuple();
...
CREATE TABLE t_json_add_column (id UInt64) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test_01825_add_column/', 'r1') ORDER BY tuple();
