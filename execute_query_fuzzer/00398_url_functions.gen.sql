...
SELECT domainRFC('//foo:bar%41%40@e-%41-example1.com') AS Host;
SELECT domainRFC('//foo:bar%41%40@example2.com') AS Host;
SELECT domainRFC('//foo%41%40:bar@example3.com') AS Host;
SELECT domainRFC('www.example4.com') as Host;
